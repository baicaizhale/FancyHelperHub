...
const STEPS = [
  {
    num: "01",
    title: "安装插件",
    desc: "丢进 plugins 文件夹即可",
    file: "服务器控制台",
    lang: "bash",
    code: [
      { type: "comment", text: "# 把 FancyHelper.jar 放进 plugins/" },
      { type: "command", text: "cp FancyHelper.jar plugins/" },
      { type: "gap" },
      { type: "comment", text: "# 重启服务器" },
      { type: "command", text: "restart" },
      { type: "gap" },
      { type: "output", text: "[FancyHelper] 插件已加载" },
      { type: "output", text: "[FancyHelper] 配置文件已生成" },
      { type: "success", text: "✓ 准备就绪" },
    ],
  },
  {
    num: "02",
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# ProtocolLib 用于捕获命令输出" },
      { type: "command", text: "/fancy lib install protocollib" },
      { type: "gap" },
      { type: "output", text: "  正在下载 ProtocolLib 5.4.0..." },
      { type: "output", text: "  校验文件完整性..." },
      { type: "gap" },
      { type: "success", text: "✓ ProtocolLib 安装完成" },
      { type: "output", text: "  重启服务器后生效" },
    ],
  },
  {
    num: "03",
    title: "配置 AI",
    desc: "默认 CloudFlare，可随意换",
    file: "plugins/FancyHelper/config.yml",
    lang: "yaml",
    code: [
      { type: "comment", text: "# 默认使用 CloudFlare Workers AI" },
      { type: "prop", key: "provider", val: "'cloudflare'" },
      { type: "prop", key: "model", val: "'gpt-oss-120b'" },
      { type: "gap" },
      { type: "comment", text: "# 也支持 OpenAI 兼容端点" },
      { type: "prop", key: "provider", val: "'openai'" },
      { type: "prop", key: "base_url", val: "'https://api.deepseek.com'" },
      { type: "prop", key: "model", val: "'deepseek-chat'" },
    ],
  },
  {
    num: "04",
    ...
    lang: "bash",
    code: [
      { type: "command", text: "/cli" },
      { type: "output", text: "[FancyHelper] 已进入 CLI 模式" },
      { type: "gap" },
      { type: "plain", text: "> 把 baicaizhale 设成管理员" },
      { type: "output", text: "  AI 思考中..." },
      { type: "output", text: "  建议执行: /op baicaizhale" },
      { type: "output", text: "  确认执行? (y/n)" },
      { type: "plain", text: "> y" },
      { type: "success", text: "✓ baicaizhale 已成为管理员" },
    ],
  },
]
  ...
  return (
    <section id="devex" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/[0.05] border border-black/[0.06] text-[10px] tracking-widest text-black/40">
            上手体验
          </div>
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.15]">
            五分钟装好，<br />腐竹们都说省心。
          </h2>
        </div>
